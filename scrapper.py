...
target_company_link = "https://www.linkedin.com/company/unilever/" # place company URL in mentioned format only!
...
class LinkedIn:
    ...
    def __init__(self):
        ...
        # user-agent is an header used to identify the client software initiating the request, typically a web browser or other software acting on behalf of a user.
